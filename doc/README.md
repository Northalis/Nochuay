...
| --- | ---------------------------------------------------- | ------------------------------------------------- |
| 01  | [Getting Started](01-getting-started.md)             | Prerequisites, setup, first run, verification     |
| 02  | [Architecture Overview](02-architecture-overview.md) | System design, layered backend, frontend patterns |
| 03  | [API Reference](03-api-reference.md)                 | All REST endpoints with request/response examples |
| 04  | [Database Guide](04-database-guide.md)               | Schema, adjacency list, migrations, JSONB content |
